 ...
 */
@Slf4j
@WebServlet("/proCollectSingle")
public class ProductCollectCountSingleServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			CacheCount.set(RedisConstants.CHECK_PRODUCT_COLLECT_SINGLE, 1L);
			String returnValue = ProductCollectCountTemplate.setOrGetPorductCollectToRedis(type, "1",productId);
			CacheCount.set(RedisConstants.CHECK_PRODUCT_COLLECT_SINGLE, 0);
