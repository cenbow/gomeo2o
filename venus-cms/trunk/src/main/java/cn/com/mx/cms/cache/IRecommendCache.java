...
public interface IRecommendCache {
	...
	void writeRecommendDataDto(String recommendType, List<RecommendDataDto> dtos);

	Long getRecommendDataRedis(String key);

	/**
	 * @Description 保存推荐位元数据
	 * @author zhangxianpeng
	 */
	void writeRecommendMetaKeys(String key, String field, String value);

	/**
	 * @Description 删除推荐位元数据
	 * @author zhangxianpeng
	 */
	void deleteRecommendMetaKeys(String key);
}
