	...
	public CommonResultEntity<Map> addMetaRecommend(RecommendMetaDto dto) {
		try {
			...
			if (StringUtil.isNotEmpty(metaData)) {
				...
				String dataSubsetRule = jsonObject.getString("dataSubsetRule")==null?"":jsonObject.getString("dataSubsetRule");
				String dataRule = jsonObject.getString("dataRule")==null?"":jsonObject.getString("dataRule");
				...
				recCache.writeRecommendMetaKeys(String.valueOf(id),"dataSubsetRule", dataSubsetRule);
				recCache.writeRecommendMetaKeys(String.valueOf(id),"dataRule", dataRule);
