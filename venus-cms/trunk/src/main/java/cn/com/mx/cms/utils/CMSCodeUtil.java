...
public final class CMSCodeUtil {
    ...
    public static final int INSERT_RECOMMENDMETA_EXCEPTION_CODE = 91060001;
	public static final String INSERT_RECOMMENDMETA_EXCEPTION_MSG = "新增推荐位元数据失败";
	
    public static final int QUERY_RECOMMENDMETA_EXCEPTION_CODE = 91060002;
	public static final String QUERY_RECOMMENDMETA_EXCEPTION_MSG = "查询推荐位元数据失败";
	
    public static final int DEL_RECOMMENDMETA_EXCEPTION_CODE = 91060003;
	public static final String DEL_RECOMMENDMETA_EXCEPTION_MSG = "删除推荐位元数据失败";
