...
public class ItemClient {
	...
	/**
	 * 
	 * @Description: 获取商品直降后价格
	 * @author duwei
	 * @param  dto
	 */
	public ItemPriceDto getItemPrices(RecommendDto dto) throws Exception {
		long id = getId(dto);
		Response<ItemPriceDto>  idresult = itemReadService.getItemPrices(id);
		if (!idresult.isSuccess()) {
			log.error("调用商品直降后价格--接口失败id={},msg={}", id, idresult.getError());
			throw CmsException.ITEM_PRICE_DESCEND_FAILE;
		}
