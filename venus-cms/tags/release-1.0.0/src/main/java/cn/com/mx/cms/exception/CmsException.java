...
public class CmsException extends BizException {
	...
	public static final BizException REBATE_PLAN_INFO_FAILE= new BizException(90060019, "获取计划信息失败");
	public static final BizException ITEM_PRICE_DESCEND_FAILE= new BizException(90060020, "获取商品直降后价格失败");
