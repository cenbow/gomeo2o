...
import cn.com.gome.trade.dto.userdto.LoginSeller;
...
//    @Export(paramNames = {"loginer","status","orderId","pageNo","size","startAt","endAt","trackType"})
    ...
    Response<PrePay> preViewPay(@NotNull(message = "user.not.login") EcpLoginUser loginUser,
     ...
     * @return 订单跟踪
     */
    Response<Paging<OrderTrack>> findNeedSettlementOrders(Date startAt,Date endAt, Integer pageNo, Integer size,String channel,String orderId,String sellerId);
    ...
    Response<Paging<OrderItemRefundTrack>> findOrderItemRefundTracks(Date startAt,Date endAt, Integer pageNo, Integer size, OrderItemRefundTrack.TrackType type,
    		@Nullable Long refundOrderId,@Nullable Long orderId);
     ...
     * @return 
     */
    Response<Map<Integer,Integer>> vshopItemCounts(String referenceId);
    /**
     * 统计买家或xpop买家订单数量
     * @param	referenceId
     * @return 
     */
    Response<Map<Integer,Integer>> queryXPOPOrderCounts(EcpLoginUser user);
}
