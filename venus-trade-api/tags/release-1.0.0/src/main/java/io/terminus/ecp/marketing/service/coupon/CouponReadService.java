...
import io.terminus.ecp.marketing.model.coupon.*;
...
public interface CouponReadService {
    ...
    public Response<Paging<CouponDefinition>> queryCouponDef(Integer type, Long shopId, Integer pageNo, Integer size);
    ...
    Response<Boolean> checkUserCoupon(@NotNull(message = "user.not.login") LoginUser loginUser,
    ...
    Response<Paging<Coupon>> queryCoupons(LoginUser loginUser, Integer type, Integer pageNo, Integer size);
