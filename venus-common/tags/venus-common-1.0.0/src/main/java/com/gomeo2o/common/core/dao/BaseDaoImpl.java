...
//	}
	...
	public PageBean listPage(PageParam pageParam, Map<String, Object> paramMap) {
		...
		// 获取分页数据集
		List<?> list = sessionTemplate.selectList(getStatement(SQL_LIST_PAGE), paramMap);
    ...
    public Long selectCount(Map<String, Object> paramMap) {  
        ...
        try {  
            ...
            throw  BizException.DB_SELECTONE_IS_NULL.newInstance("数据库操作,selectCount返回null", getStatement(SQL_LIST_PAGE_COUNT));
        }  
    }  
