...
public class CouponInfoDaoImpl extends BaseDaoImpl<CouponInfo> implements CouponInfoDao {
	...
	/**
	 * 
	 * @Description:取消订单，回退优惠券状态
     * @author: fengxin
     * @date: 2016年1月21日 下午4:18:37
     * @return void    
	 */
	public void resetCouponInfoState(List<String> list){
		//this.getSessionTemplate().update("com.gomeo2o.service.account.dao.impl.CouponInfoDaoImpl.resetCouponInfoState", list);
		Map<String,Object> map ;
		for(int i = 0; i < list.size(); i++) {
			map =  new HashMap<String,Object>();
			map.put("orderNo",list.get(i));
			this.getSqlSession().update("com.gomeo2o.service.account.dao.impl.CouponInfoDaoImpl.resetCouponInfoStateByMap",map);
		}
