...
public class Constants {
	...
	//开发SAP对接url
	//public static final String SOAP_URL = "http://10.125.31.47:50000/sap/xi/adapter_plain?namespace=http://gome.com/ACC/FI/Outbound&interface=SI_FI_Out_Asy&service=BS_ACC&party=&agency=&scheme=&QOS=EO&sap-user=ACCUSER&sap-password=ACCUSER&sap-client=001&sap-language=EN";
	//测试SAP对接url
	//public static final String SOAP_URL = "http://10.125.31.41:50000/sap/xi/adapter_plain?namespace=http://gome.com/ACC/FI/Outbound&interface=SI_FI_Out_Asy&service=BS_ACC&party=&agency=&scheme=&QOS=EO&sap-user=ACCUSER&sap-password=ACCUSER&sap-client=001&sap-language=EN";
	public static final String SOAP_URL = PropertiesUtil.getProProperties("soapUrl", null);
	//商家返利
